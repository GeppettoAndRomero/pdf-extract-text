...
const CACHE_NAME = 'pdf-extract-text-v1';
const RUNTIME_CACHE = 'pdf-extract-text-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/pdf-extract-text/',
  '/pdf-extract-text/manifest.json',
  '/pdf-extract-text/icon-192.png',
  '/pdf-extract-text/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/pdf-extract-text/manifest.json';
}
