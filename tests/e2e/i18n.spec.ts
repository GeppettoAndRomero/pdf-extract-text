...
test.describe('i18n', () => {
  ...
  for (const loc of [
    { path: '/pdf-extract-text/', lang: 'en' },
    { path: '/pdf-extract-text/ja/', lang: 'ja' },
  ]) {
  ...
  test('serves every locale with the correct <html lang>', async ({ page }) => {
    const expected: Array<[string, string]> = [
      ['/pdf-extract-text/', 'en'],
      ['/pdf-extract-text/ja/', 'ja'],
      ['/pdf-extract-text/zh/', 'zh-Hans'],
      ['/pdf-extract-text/de/', 'de'],
      ['/pdf-extract-text/es/', 'es'],
    ];
