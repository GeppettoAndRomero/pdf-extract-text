...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/pdf-extract-text/sw.js, scope=/pdf-extract-text/）。
    // scope がツールの全 locale ページ（/pdf-extract-text/, /pdf-extract-text/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/pdf-extract-text/sw.js', {
